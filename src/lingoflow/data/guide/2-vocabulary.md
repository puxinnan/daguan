...
根据牛津英文语料库（OEC）的单词分布统计，我们可以得出以下简单结论：
...
举个例子:'cat' => '猫';单词软件可能会给你提供某个具体的关于猫的图片。但其实在你脑海里，应该建立一个你抽象后的形象代表猫，而不是死记某一张具体的图片。
...
然而大部分听觉型学习者并不了解听觉型学习的正确方法，在他们意识到自己属于听觉型学习者的时候很可能已经养成的视觉型学习的习惯。
...
你甚至可以在单词附近做一些记号，比如用三角形代表"这是个有趣的单词"，圆代表"这是最近看的某本书或某个视频里面的"，耳朵符号表示"发音比较没把握"等。

这个习惯我一直保留至今，只不过我不再用纸质的本子，而是将其同步到了词典软件上，每天午休期间和晚上健身后翻翻。
我搭配使用上面介绍的两种背单词的方法，因为当你的单词本单词达到 500 甚至更多的时候，你需要尽可能复习更多的单词。
不然就得准备厚重的纸质词典经常翻阅。不过纸质字典携带起来极为不便，还是给自己准备一套顺手的词典软件吧。
...
至于我使用的是哪个词典软件，就不打广告了，只要是拥有多端同步的 app 对我而言都差不多。很多单词就算复习了多年，有时候还是不敢确定自己完全记住了，所以集中管理非常重要。
...
- [17天搞定GRE单词](https://book.douban.com/subject/1803504/)
